      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-sm sm:text-base text-gray-300">(555) 123-4567</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-sm sm:text-base text-gray-300 break-all">info@heritagebuilders.com</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-sm sm:text-base text-gray-300">123 Builder St, City, ST 12345</p>
          </motion.div>
        </div>
        ...
        >
          <p className="text-sm sm:text-base text-gray-400">
            © 2024 Heritage Builders. All rights reserved.
          </p>
        </motion.div>
      </div>
    </section>
